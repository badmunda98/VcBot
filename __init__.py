...
from BadBoy import HNDLR, LOGS, asst, udB, vcClient
from BadBoy._misc._decorators import compile_pattern
...
from BadBoy.fns.admins import admin_check
from BadBoy.fns.tools import is_url_ok
from BadBoy.fns.ytdl import get_videos_link
from BadBoy._misc import owner_and_sudos, sudoers
from BadBoy._misc._assistant import in_pattern
from BadBoy._misc._wrappers import eod, eor
from BadBoy.version import __version__ as UltVer
...
async def file_download(event, reply, fast_download=True):
    thumb = "https://telegra.ph/file/c72daaa7a1af62b531d19.mp4"
